...
public class QueryUnit implements UnitTypesImpl{
	...
	public QueryUnit(String stringData) throws ParseException {
	...
	private void setTimeWait(String s) throws ParseException {
		waitingTime = Integer.parseInt(s);
	}

	private void setDate(String s) throws ParseException {
		String[] line = s.split("-");
